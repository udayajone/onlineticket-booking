...
from ticketprocess.forms import busform,consumerform
...
def update_view(request,id):
    ...
    if request.method =='POST':
        ...
        return redirect('/display')
    return render(request,'ticketprocess/update.html',{"bus_data":bus_data})
...
def consumerdisplay_view(request):
    ...
    return render(request,"ticketprocess/consumer_display.html",{"info":info})
...
def consumer_view(request):
    ...
    return render(request,'ticketprocess/consumer.html',{'form':form})
...
def updateconsumer_view(request, id):
        ...
        if request.method == ('POST'):
            ...
            consumer_data.save()
            return redirect('/consumerdisplay')
        return render(request, 'ticketprocess/updateconsumer.html', {"consumer_data": consumer_data})